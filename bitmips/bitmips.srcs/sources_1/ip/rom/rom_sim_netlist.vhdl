...
\synth_options.dist_mem_inst\: entity work.rom_dist_mem_gen_v8_0_12_synth
     port map (
      ...
      spo(14) => \^spo\(19),
      spo(13) => \^spo\(16),
      spo(12 downto 5) => \^spo\(14 downto 7),
      spo(4 downto 2) => \^spo\(5 downto 3),
      spo(1 downto 0) => \^spo\(1 downto 0)
    );
end STRUCTURE;
library IEEE;
